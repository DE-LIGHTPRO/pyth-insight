...
export const PRICE_IDS: Record<string, string> = {
  ...
  // MATIC/USD deprecated on Hermes; POL/USD (Polygon rebrand) replaced — removed
  // until the correct 64-char Pyth feed ID can be verified via pyth.network/price-feeds
  // "POL/USD": "0x...",
...
export const BENCHMARKS_SYMBOLS: Record<string, string> = {
  ...
  // "POL/USD": "Crypto.POL/USD", // removed — feed ID unverified
