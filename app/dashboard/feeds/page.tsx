  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-10">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4 mb-8">
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs text-slate-600">via Hermes SSE</span>
          </div>
          <h1 className="text-2xl font-bold text-white">Live Price Feeds</h1>
          <p className="text-slate-400 text-sm mt-1 max-w-xl">
            Real-time prices for 20 assets streamed directly from Pyth Hermes.
      ...
      <p className="mt-8 text-xs text-slate-600 leading-relaxed max-w-2xl">
        Prices stream via Server-Sent Events from{" "}
